...
dshs_D_17 <- read.dbf("C:\\Users\\kaitl\\Documents\\Every Texan\\R\\Bexar-County-Charity-Care-Costs\\ASH2016Dataset\\HS16CD.dbf") 

# Read DSHS facility information data
dshs_dir_17 <- read.dbf("C:\\Users\\kaitl\\Documents\\Every Texan\\R\\Bexar-County-Charity-Care-Costs\\ASH2016Dataset\\HS16DIR.dbf") 

# Read DSHS Section I Inpatient and Outpatient Bad Debt and Charity Charges Data
dshs_I_17 <- read.dbf("C:\\Users\\kaitl\\Documents\\Every Texan\\R\\Bexar-County-Charity-Care-Costs\\ASH2016Dataset\\HS16EI.dbf") 
...
list_hospitals = list(dshs_dir_17,dshs_D_17,dshs_I_17)
...
transform(hospital_data_17, D3M1 = as.numeric(D3M1))
transform(hospital_data_17, D4C1 = as.numeric(D4C1))
transform(hospital_data_17, D3C1 = as.numeric(D3C1))
transform(hospital_data_17, D5A1 = as.numeric(D5A1))
transform(hospital_data_17, D5B1 = as.numeric(D5B1))
...
hospital_data_17$charity_costs_f <- 
  hospital_data_17$D5B1 * hospital_data_17$ctc_ratio
